    ...
    public function faceRecords()
{
    ...
    return Inertia::render('Hr/Face/Records', [
        'users' => $users,
    ]);
}
    ...
    public function registerFace(Request $request, User $user)
    {
        ...
        $response = Http::post('http://127.0.0.1:5005/encode', [
            'image' => $request->image,
        ]);
    ...
    public function faceLogs()
{
    ...
    return Inertia::render('Hr/Face/Logs', [
        'logs' => $logs,
    ]);
}
...
public function settingsPage()
{
    ...
    return Inertia::render("Hr/Face/Settings", [
        "settings" => $settings,
    ]);
}
