...
/**
* @see \App\Http\Controllers\SuperAdmin\LeaveController::index
 * @see app/Http/Controllers/SuperAdmin/LeaveController.php:12
 * @route '/super-admin/leaves'
 */
...
/**
* @see \App\Http\Controllers\SuperAdmin\LeaveController::approve
...
approve.definition = {
    methods: ["post"],
    url: '/super-admin/leaves/{leave}/approve',
...
/**
* @see \App\Http\Controllers\SuperAdmin\LeaveController::reject
...
reject.definition = {
    methods: ["post"],
    url: '/super-admin/leaves/{leave}/reject',
} satisfies RouteDefinition<["post"]>
