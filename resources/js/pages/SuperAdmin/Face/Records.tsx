...
import { Users, CheckCircle, Camera, XCircle, Search, Filter } from "lucide-react";
            ...
            <div className="p-6 bg-neutral-50 dark:bg-neutral-950 min-h-screen">
                ...
                <Modal show={showModal} onClose={() => setShowModal(false)}>
                    <h2 className="text-xl font-semibold mb-4 flex items-center gap-2 text-neutral-900 dark:text-white">
                        <Camera className="w-6 h-6" /> Register Face
                    </h2>
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="flex gap-3 mt-4">
                            <button
                                ...
                                className="px-4 py-2 border border-neutral-300 dark:border-neutral-700 rounded-lg dark:text-white"
                            >
                                Cancel
                            </button>
